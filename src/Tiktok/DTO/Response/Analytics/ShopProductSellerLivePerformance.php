...
/**
 * `seller_live_performance`: o produto nas lives DA PROPRIA LOJA.
 * Tudo aqui e' ATRIBUIDO (`attributed*`) ao canal, nao total.
 * `newLiveCount` e' o campo que o distingue do canal de video.
 */
final class ShopProductSellerLivePerformance implements DTOInterface
{
    use AutoHydrate;
    use CastToArray;
