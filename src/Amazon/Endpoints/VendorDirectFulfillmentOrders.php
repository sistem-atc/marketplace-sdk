...
/**
 * Vendor Direct Fulfillment Orders API (2021-12-28) — pedidos de
 ...
 *
 * Path base: /vendor/directFulfillment/orders/2021-12-28.
 * Respostas SEM envelope `payload` (`orders`, `pagination.nextToken` no root).
 * Rate limit do modelo: 10 req/s, burst 10.
 */
class VendorDirectFulfillmentOrders
{
    private const BASE = '/vendor/directFulfillment/orders/2021-12-28';
